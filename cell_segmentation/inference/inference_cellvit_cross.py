...
# Without merging WSI
#
# Aim is to calculate metrics as defined for the all datasets
#
...
class InferenceCellViTCross:
    def __init__(
        ...
        self.inference_dataset = select_dataset(
    ...
    def __load_dataset_setup(self, dataset_path: Union[Path, str]) -> None:
        ...
        self.num_testset_nuclei_classes = len(self.dataset_config["nuclei_types"])
    ...
    def __get_model(
        ...
        Returns:
            Union[CellViT, CellViTShared, CellViT256, CellViT256Shared, CellViTSAM, CellViTSAMShared, CellViTUNI]: Model
        """
        implemented_models = [
            "CellViT",
            "CellViTShared",
    ...
    def inference_step(
        ...
        if generate_plots:
            self.plot_results(
                ...
                num_nuclei_classes=self.num_testset_nuclei_classes,
    ...
    def unpack_masks(
        ...
        gt_nuclei_type_maps_onehot = F.one_hot(
            nuclei_type_maps, num_classes=self.num_testset_nuclei_classes
        ).type(
            torch.float32
...
class InferenceCellViTParser:
    def __init__(self) -> None:
        ...
        parser.add_argument(
            "--plots",
            action="store_true",
            help="Generate inference plots in outdir",
        )
...
if __name__ == "__main__":
    ...
    inf = InferenceCellViTCross(
        outdir="/home/xijiexu/clone/CellViT/log/inference",
