...
class CellViTAdapter(TimmVisionTransformer):
    ...
    def forward(self, x):
        ...
        # print(deform_inputs1[1], deform_inputs2[1])
        # print(deform_inputs1[2], deform_inputs2[2])
        ...
        for i, layer in enumerate(self.interactions):
            ...
            # print(self.blocks[indexes[0]:indexes[-1] + 1])
            # print(deform_inputs1[0].shape, deform_inputs2[0].shape)
